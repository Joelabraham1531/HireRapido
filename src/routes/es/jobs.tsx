...
export const Route = createFileRoute("/es/jobs")({
  component: Jobs,
});
    ...
    <section className="route-hero bg-gradient-to-br from-brand-gold/10 via-brand-orange/5 to-brand-orange/10 pt-32 pb-20 text-center">
      <div className="mx-auto max-w-4xl px-6">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl text-foreground">
          <span className="text-gradient-brand">Empleos en HireRapido</span> - Bolsa de trabajo remoto para talento en Latinoamérica
        </h1>
        <p className="mt-8 text-lg font-medium text-foreground max-w-3xl mx-auto leading-relaxed">
          La misión de HireRapido es conectar talento de élite de LatAm con empresas líderes de EE. UU. Explora puestos remotos de tiempo completo y medio tiempo en ventas, marketing, diseño, contabilidad y mucho más, tanto en startups innovadoras como en empresas reconocidas. ¡Postúlate en línea en solo cinco minutos!
        </p>
        <div className="mt-10">
          <a href="/es/#connect" className="inline-block rounded-full bg-foreground px-8 py-3 text-sm font-bold text-primary-foreground shadow-brand hover:opacity-90 transition-opacity">
...
function JobListings() {
  ...
  const jobs = [
    { title: "Ingeniero Senior de IA", time: "hace 1 día", company: "Lemon.io" },
    { title: "Especialistas en Etiquetado de Datos", time: "hace 2 días", company: "At Workad..." },
    { title: "Gerente de Comunicaciones", time: "hace 3 días", company: "Marketp..." },
    { title: "Especialista en Éxito del Cliente (CSM)", time: "hace 4 días", company: "Impact..." },
    { title: "Asistente de Ventas", time: "hace 1 semana", company: "Innovati..." }
  ];
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3 mt-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-muted/50 border border-border/50 text-xs font-semibold text-muted-foreground">
                    <MapPin className="w-3 h-3" /> Remoto
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-muted/50 border border-border/50 text-xs font-semibold text-muted-foreground">
