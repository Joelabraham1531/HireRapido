      ...
      <div className="portal-shell hero-layout grid items-center gap-10 py-10 sm:py-12 lg:grid-cols-[1.06fr_0.94fr] lg:gap-8 lg:py-12 xl:gap-10 xl:py-14 2xl:max-w-[1440px] 2xl:py-16">
        ...
        <div className="hero-copy order-1 text-center lg:order-2 lg:text-left">
          <div className="portal-eyebrow">
            ...
            LATAM TALENT PLATFORM <span className="text-brand-gold">800K+ PROFILES</span>
          </div>
          <h1 className="mx-auto mt-5 max-w-3xl text-5xl font-extrabold leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:mx-0 lg:mt-4 lg:text-[clamp(3.35rem,4.7vw,4.15rem)] 2xl:text-[4.4rem]">
            Hire <span className="text-gradient-brand">LATAM talent</span>
            <br />for 80% less
          </h1>
          ...
          <div className="portal-searchbar mx-auto mt-6 max-w-2xl lg:mx-0 lg:mt-5">
            ...
            <a href="#connect" className="rounded-2xl bg-foreground px-5 py-3.5 text-center text-sm font-bold text-primary-foreground shadow-sm transition hover:-translate-y-0.5">
              Hire Talent
            </a>
          </div>
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2 lg:mt-3 lg:justify-start">
            <span className="mr-1 text-[11px] font-extrabold uppercase tracking-[0.18em] text-muted-foreground">Popular</span>
            <a href="/hire-latam-developers" className="portal-chip">Developers</a>
            <a href="/hire-latam-medical-assistants" className="portal-chip">Medical Assistants</a>
            <a href="/hire-latam-accountants" className="portal-chip">Accountants</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div className="hero-visual relative mx-auto w-full max-w-[540px] px-4 py-8 sm:px-8 lg:max-w-[520px] lg:py-5 xl:max-w-[560px] 2xl:max-w-[590px]">
      ...
      <div className="portal-panel float-card float-card-a absolute left-0 top-1 flex items-center gap-4 rounded-[1.35rem] px-4 py-3 sm:left-1 sm:px-5">
        <div>
          ...
          <p className="mt-0.5 text-[11px] font-semibold text-muted-foreground">Senior Sales Lead</p>
        </div>
        <div className="flex h-12 w-12 items-center justify-center rounded-full border-[3px] border-brand-orange text-sm font-extrabold">98%</div>
      </div>
      <div className="portal-eyebrow float-card float-card-b absolute right-0 top-16 hidden sm:flex">
        <MapPin className="h-3.5 w-3.5 text-brand-orange" /> US time zones
      </div>
      <div className="portal-badge-dark float-card float-card-c absolute -bottom-1 right-1 flex items-center gap-3 px-5 py-3.5 sm:right-5">
        <div>
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-white/60">Top 3% talent</p>
        </div>
      ...
      <div className="portal-panel float-card float-card-d absolute -left-1 bottom-5 hidden max-w-[210px] rounded-[1.35rem] px-4 py-3 sm:block">
        ...
        <p className="mt-1 text-[11px] font-medium leading-5 text-muted-foreground">Browse and interview before you commit.</p>
      </div>
    </div>
  );
}
...
const talents = [
  { name: "Melisa N.", role: "Marketing & Graphic Design", rate: "1,500", img: melisa, flag: "🇦🇷", skills: ["Digital Marketing", "Graphic Design", "Illustration", "Adobe"], levels: [["Digital Marketing", 80], ["Graphic Design", 85], ["Illustration", 90]] },
  { name: "Fernando G.", role: "Copywriter", rate: "3,000", img: fernando, flag: "🇲🇽", skills: ["Copywriting", "Screenwriting", "Community Manager", "Creative Writing"], levels: [["Copywriting", 80], ["Screenwriting", 85], ["Community Manager", 85]] },
  { name: "Yolanda L.", role: "Customer Service & BDR", rate: "1,800", img: yolanda, flag: "🇨🇴", skills: ["Customer Service", "Client Relations", "Administrative Assistance"], levels: [["Customer Service", 80], ["Microsoft Office", 80], ["Administrative Assistance", 80]] },
  { name: "Rodrigo A.", role: "Senior Software Developer", rate: "3,499", img: oliver, flag: "🇧🇷", skills: ["React.JS", "Node.JS", "Blockchain", "AngularJS"], levels: [["Blockchain", 95], ["React.JS", 90], ["Node.JS", 90]] },
] as const;
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-10 max-w-3xl">
          <h2 className="text-4xl font-extrabold sm:text-5xl">
            Hire <span className="text-gradient-brand">top 3%</span> LatAm talent
          </h2>
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg font-medium leading-8 text-muted-foreground">
            HireRapido connects US companies with top technical and non-tech LatAm
            talent. Our curated shortlists and in-depth profiles make finding
            your dream hire a piece of cake .
          </p>
...
const cases = [
  { img: case1, title: "Design Portfolio Site Dribbble Saved 85% by Hiring SDR Team with HireRapido" },
  { img: case2, title: "Leading Fintech Basis Theory Saves 50% on Tech and Non-Tech Teams" },
  { img: case3, title: "How Ecommerce Darling Dr Squatch Built Their Tech Team & Saved 70%" },
];
...
const steps = [
  { img: stepProfile, title: "Set up your hiring profile", body: "Import your existing job description or use our in-house AI to build one from scratch." },
  { img: stepMatch, title: "Match within 24 hrs", body: "Use AI Magic to find your perfect fit, or browse our complete pre-vetted talent pool." },
  { img: stepGrow, title: "Grow your team", body: "while HireRapido takes care of HR, international payroll, and legal compliance." },
];
...
const vetting = [
  { n: 1, title: "AI-powered assessment", body: "Our in-house AI evaluates a talent's initial interview and resume for hard and soft skills, experience, and spoken English ability." },
  { n: 2, title: "Skills evaluation", body: "All talents' skills are given a rating that will appear on their profile." },
  { n: 3, title: "Background check", body: "We ensure that all talents have presented themselves accurately, including confirming their prior work history." },
  { n: 4, title: "Listing on HireRapido", body: "We present a comprehensive profile of our talents, including prior experience and skills." },
];
    ...
    <section className="portal-section portal-tint">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-12 max-w-2xl">
          <h2 className="text-4xl font-extrabold sm:text-5xl">
            How we find <span className="text-gradient-brand">top 3%</span> talent
          </h2>
        ...
        <div className="vetting-layout relative grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
          {vetting.map((v, i) => (
            <div key={v.n} className={`portal-card portal-card-hover vetting-card vetting-card-${i} p-6`}>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <a href="#jobs" className="rounded-full border border-foreground px-6 py-3 text-sm font-semibold hover:bg-foreground hover:text-primary-foreground">Find jobs</a>
          <a href="#connect" className="rounded-full bg-foreground px-6 py-3 text-sm font-semibold text-primary-foreground">Hire top talent</a>
        </div>
      </div>
    </section>
  );
...
const services = [
  { icon: <Clock className="h-5 w-5" />, title: "Global Payroll Management", body: "Streamlined international payment processing to ensure timely and accurate compensation across borders." },
  { icon: <ShieldCheck className="h-5 w-5" />, title: "Compliance Assurance", body: "Automated adherence to local labor laws, tax regulations, and employment standards to reduce legal risks." },
  { icon: <HeartHandshake className="h-5 w-5" />, title: "Integrated Benefits", body: "We offer health insurance through our partner, SafetyWing, for an additional $106/mo per talent." },
  { icon: <Users className="h-5 w-5" />, title: "Comprehensive HR", body: "We take care of all your backend Human Resources needs while you manage the talent directly." },
];
...
const roleCategories = ["Marketing", "Developers", "Design", "Technology", "Sales", "Accounting", "Operations", "& More"] as const;

const roles: Record<string, { title: string; saving: string; price: string; body: string }[]> = {
  Marketing: [
    { title: "Copywriter", saving: "Up to 70% Savings", price: "$1,900/month", body: "A pre-vetted HireRapido copywriter can craft persuasive, engaging content that boosts your marketing efforts." },
    { title: "Marketing Assistant", saving: "Up to 60% Savings", price: "$2,100/month", body: "Streamline marketing campaigns by handling admin tasks, social media, and coordination." },
    { title: "SEO Specialist", saving: "Up to 55% Savings", price: "$2,600/month", body: "Optimize your website to rank higher on search engines, driving organic traffic and visibility." },
  ],
  Developers: [
    { title: "Full Stack Developer", saving: "Up to 65% Savings", price: "$5,800/month", body: "Proficient in frontend and backend, essential for building anything from mobile apps to AI." },
    { title: "Front End Developer", saving: "Up to 70% Savings", price: "$4,300/month", body: "Create visually appealing, user-friendly websites and applications." },
    { title: "Back End Developer", saving: "Up to 65% Savings", price: "$4,900/month", body: "Build and maintain the server-side of a website or application." },
  ],
  Design: [
    { title: "Web Designer", saving: "Up to 65% Savings", price: "$2,800/month", body: "Combine programming know-how with creative flair to refresh or create new brand identities." },
    { title: "Graphic Designer", saving: "Up to 70% Savings", price: "$2,300/month", body: "Bring your brand to life with impactful visuals that resonate with your audience." },
    { title: "Video Editor", saving: "Up to 65% Savings", price: "$2,100/month", body: "Transform raw footage into polished content that captivates your audience." },
  ],
  Technology: [
    { title: "AI Engineer", saving: "Up to 65% Savings", price: "$5,800/month", body: "Experienced developers specializing in NLP, computer vision, and predictive analytics." },
    { title: "DevOps Engineer", saving: "Up to 70% Savings", price: "$4,300/month", body: "Automate processes and streamline development using CI/CD pipelines and cloud tech." },
    { title: "QA Engineer", saving: "Up to 65% Savings", price: "$3,100/month", body: "Vital experience in manual and automated testing, plus automation scripting." },
  ],
  Sales: [
    { title: "Sales Development Rep", saving: "Up to 80% Savings", price: "$1,900/month", body: "Take prospects from top-of-funnel through purchase — and to repeat clients." },
    { title: "Account Manager", saving: "Up to 65% Savings", price: "$2,300/month", body: "Strengthen your relationship with clients and keep them coming back." },
    { title: "Business Development Rep", saving: "Up to 60% Savings", price: "$2,300/month", body: "Fuel growth and take your sales strategy to the next level." },
  ],
  Accounting: [
    { title: "Accountant", saving: "Up to 65% Savings", price: "$2,500/month", body: "Manage your company's financial health, from reports to tax filings and compliance." },
    { title: "Financial Analyst", saving: "Up to 70% Savings", price: "$2,800/month", body: "Data-driven insights on budgeting, forecasting, and investment." },
    { title: "Bookkeeper", saving: "Up to 55% Savings", price: "$2,000/month", body: "Streamline invoicing, payroll, tax returns and financial reporting." },
  ],
  Operations: [
    { title: "Project Manager", saving: "Up to 75% Savings", price: "$2,600/month", body: "Oversee projects from initiation to completion with timely delivery." },
    { title: "Executive Assistant", saving: "Up to 65% Savings", price: "$1,900/month", body: "Manage schedules, communications, and admin tasks for your leadership team." },
    { title: "Customer Support", saving: "Up to 65% Savings", price: "$1,900/month", body: "Facilitate efficient communication and problem-solving with your client base." },
  ],
  "& More": [
    { title: "Data Analyst", saving: "Up to 65% Savings", price: "$2,500/month", body: "Interpret your data to uncover trends, inform strategy, and improve decisions." },
    { title: "Human Resources Manager", saving: "Up to 60% Savings", price: "$2,800/month", body: "Streamline HR from recruitment to onboarding and compliance." },
    { title: "Transcriptionist", saving: "Up to 50% Savings", price: "$2,000/month", body: "Convert audio and video content into accurate written documents." },
  ],
};
...
function Expertise() {
  ...
  return (
    <section id="pricing" className="portal-section portal-tint">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="text-4xl font-extrabold sm:text-5xl">
          HireRapido offers expertise in <span className="text-gradient-brand">every field</span>
        </h2>
        ...
        <div className="expertise-layout mt-10 grid gap-6 md:grid-cols-12">
          {roles[active].map((r, i) => (
            <div key={r.title} className={`portal-card portal-card-hover expertise-card expertise-card-${i} role-swap-in p-6`}>
              <h3 className="text-xl font-bold">{r.title}</h3>
              <p className="mt-1 text-sm font-semibold text-brand-gold">{r.saving}</p>
              <p className="mt-3 text-2xl font-extrabold text-gradient-brand">{r.price}</p>
              <p className="mt-3 text-sm text-muted-foreground">{r.body}</p>
              <a href="#connect" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold hover:text-brand-orange">
                Hire this role <ArrowRight className="h-4 w-4" />
              </a>
            </div>
          ))}
        </div>
        ...
        <div className="portal-panel mt-16 grid gap-8 p-8 md:grid-cols-[auto_1fr] md:items-center">
          <img src={ashley} alt="Ashley Rector" className="h-32 w-32 rounded-full object-cover" loading="lazy" width={640} height={640} />
          <div>
            ...
            <p className="mt-3 text-lg italic">
              ...
              HireRapido to hire for three roles out of Latin America. The team has
              found perfect fits, the process was easy, and actually
              affordable... this has saved me a giant headache!"
            </p>
            <p className="mt-3 font-bold">— Ashley Rector</p>
          </div>
        </div>
      </div>
    </section>
...
const faqs = [
  { q: "What is HireRapido?", a: "HireRapido is the largest pre-vetted pool of Latin American remote talent. We match US companies with experienced LatAm professionals across sales, marketing, tech, administration and more." },
  { q: "How does HireRapido work?", a: "After signing up to our platform, import your job description and start exploring our talent pool of 800,000+ pre-vetted professionals. Receive AI-recommended suggestions or let our senior talent team create a custom shortlist." },
  { q: "What are the benefits of hiring in Latin America?", a: "By hiring in LatAm, North American companies can save up to 80% on professionals who are fluent in English and located in the same time zones. Plus, hire 10x faster with HireRapido's pre-vetted, AI-powered talent platform!" },
  { q: "How much can I save with HireRapido?", a: "On average, our clients save 80% when they hire Latin American talents with HireRapido. Most roles can be filled for under $3,000 USD per month." },
  { q: "Which roles should I hire in LatAm?", a: "HireRapido boasts a diverse pool of talents across sales, tech, marketing, operations, administration and more." },
  { q: "How long does it take to hire?", a: "Thanks to our in-house AI vetting system, all talents in our platform are pre-vetted and available to start immediately — you can hire in as little as 24 hours!" },
];
          ...
          {faqs.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                {isOpen && <p className="faq-answer mt-3 text-muted-foreground">{f.a}</p>}
              </button>
            );
          })}
        </div>
        <div className="faq-actions flex flex-wrap justify-center gap-3 lg:col-start-2">
          <a href="#connect" className="rounded-full border border-foreground px-6 py-3 text-sm font-semibold hover:bg-foreground hover:text-primary-foreground">Book a consultation</a>
          <a href="#connect" className="rounded-full bg-foreground px-6 py-3 text-sm font-semibold text-primary-foreground">Get started</a>
        </div>
      </div>
    </section>
  );
    ...
    <section className="portal-section portal-tint">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold sm:text-4xl">Join our amazing clients!</h2>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
          {clientLogos.map((l) => (
            <span key={l} className="text-2xl font-bold text-muted-foreground/70">{l}</span>
          ))}
        </div>
        ...
        <div className="portal-panel portal-tint final-cta mt-16 overflow-hidden p-10 text-center sm:p-14 lg:p-16">
          <h2 className="text-4xl font-extrabold sm:text-6xl">
            Ready to hire top <span className="text-gradient-brand">Latin American</span> talent?
          </h2>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a href="#jobs" className="rounded-2xl border border-foreground px-6 py-3 text-sm font-semibold text-foreground transition hover:bg-foreground hover:text-primary-foreground">Find jobs</a>
            <a href="#connect" className="rounded-2xl bg-foreground px-6 py-3 text-sm font-semibold text-primary-foreground shadow-sm transition hover:-translate-y-0.5">Hire top talent</a>
          </div>
        </div>
      </div>
    </section>
